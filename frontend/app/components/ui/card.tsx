...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-6 overflow-hidden rounded-sm border border-border bg-card py-6 text-sm text-card-foreground shadow-[0_8px_24px_rgba(29,66,54,0.06)] has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4",
        className
      )}
      {...props}
    />
